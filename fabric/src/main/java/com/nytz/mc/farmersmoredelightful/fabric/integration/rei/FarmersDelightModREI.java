...
public class FarmersDelightModREI implements REIClientPlugin {
    ...
    public void registerCategories(CategoryRegistry registry) {
        registry.addWorkstations(COOKING, EntryStacks.of(BlocksRegistry.FRYING_PAN.get()));
    }

    @Override
    public void registerScreens(ScreenRegistry registry) {
        registry.registerContainerClickArea(new Rectangle(89, 25, 24, 17), FryingPanScreen.class, COOKING);
    }
